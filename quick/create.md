...
| 加速域名  | 指需要使用CDN加速的域名，如example.com，不能以HTTP或者HTTPS开头。<br/> 如开通的加速区域为境内加速，接入的域名必须在工信部备案后方可接入。<br/> 账户维度默认加速域名配额数量20个。<br /> 如需创建泛域名加速，请联系技术支持。 <br />如配置加速区域为境外或者全球加速，特殊配置请联系spt或者客户经理操作|
