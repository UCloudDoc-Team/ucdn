...
| 加速区域  | 目前支持境内加速和境外加速，境内：中国大陆，境外：海外加港澳台 ,目前全站加速支持境内加速和境外加速 <br/>流量计费模式下，只有购买了境外流量才能选择境外加速区域，带宽计费模式没有限制，若要调整加速区域，请联系技术支持或客户经理|
...
| 缓存配置  | 缓存配置请参考 [缓存配置](../ucdn/domain/config/cache) |
